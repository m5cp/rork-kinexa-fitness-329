...
enum LegalPages {
    ...
    static let privacyPage = LegalPage(
        ...
        sections: [
            ...
            LegalSection(icon: "hand.raised.slash", title: "No Tracking", body: "MVM GetFit contains no analytics SDKs, no advertising frameworks, no user tracking, and no telemetry. Your usage data is not monitored, recorded, or transmitted.", tint: KinexaTheme.accent),
            LegalSection(icon: "apple.intelligence", title: "Apple Intelligence (On-Device AI)", body: "MVM GetFit includes optional AI-powered features using Apple Intelligence, which runs entirely on your device via Apple's Foundation Models framework.\n\nHow it works:\n• AI insights analyze your workout history and training patterns to generate personalized progress analysis, weekly summaries, and coaching tips.\n• All AI processing happens locally on your iPhone using Apple's on-device language model. No data is sent to any server, cloud service, or third party.\n• Your fitness data never leaves your device for AI processing.\n\nDevice requirements:\n• Apple Intelligence features require iPhone 15 Pro or later running iOS 26 or newer, with Apple Intelligence enabled in Settings.\n• On devices that do not meet these requirements, AI features are simply not shown. The app functions fully without them.\n\nApple Intelligence is governed by Apple's own privacy policies. MVM GetFit does not control or modify Apple's on-device AI model.", tint: Color(hex: "#6366F1")),
            LegalSection(icon: "person.2.slash", title: "Children", body: "MVM GetFit is not designed for or directed at children under 13. We do not knowingly collect information from minors.", tint: KinexaTheme.tertiaryText),
    ...
    static let termsPage = LegalPage(
        ...
        sections: [
            ...
            LegalSection(icon: "heart.text.square", title: "Health Data", body: "If you grant Apple Health access, MVM GetFit reads your activity data for display within the app and writes completed Quick Start workout sessions back to Apple Health so they contribute to your activity rings and workout history. This data is never sold, shared, or transmitted externally. Your health data stays on your device at all times.", tint: KinexaTheme.accent2),
            LegalSection(icon: "person.fill.checkmark", title: "User Responsibility", body: "You are solely responsible for:\n\n• Knowing your physical capabilities and limitations\n• Using proper exercise form and technique\n• Stopping activity if you experience pain, dizziness, or discomfort\n• Consulting a qualified medical professional before starting any exercise program\n• Ensuring exercises you select are appropriate for your fitness level\n\nMVM GetFit provides tools — your safety decisions are your own.", tint: KinexaTheme.accent),
            LegalSection(icon: "shield.slash", title: "Limitation of Liability", body: "The developer is not responsible for any injuries, damages, health outcomes, or losses resulting from use of this app. MVM GetFit is provided \"as is\" without warranties of any kind, express or implied. All workout content is based on publicly available fitness standards and is provided for informational and tracking purposes only.", tint: KinexaTheme.tertiaryText),
            LegalSection(icon: "exclamationmark.triangle", title: "Misuse", body: "You agree not to use MVM GetFit for any purpose that is unlawful, harmful, or inconsistent with its intended use as a personal fitness tracking tool. The developer reserves the right to update these terms at any time.", tint: KinexaTheme.warning),
            LegalSection(icon: "apple.intelligence", title: "Apple Intelligence Features", body: "MVM GetFit includes optional AI-powered features using Apple Intelligence (iOS 26+, iPhone 15 Pro or later). These features provide training insights, weekly summaries, and coaching tips generated on-device.\n\nBy using these features, you acknowledge that:\n\n• AI-generated content is for informational purposes only and is not a substitute for professional fitness or medical advice\n• The on-device AI model may produce inaccurate, incomplete, or generic responses\n• All AI processing occurs locally on your device — no data is transmitted externally\n• AI features are optional and the app functions fully without them\n• Apple Intelligence availability depends on your device model, iOS version, and Settings configuration", tint: Color(hex: "#6366F1")),
            LegalSection(icon: "lock.doc", title: "Intellectual Property", body: "All content, design, code, and branding within MVM GetFit belong to the developer. Workout templates are based on publicly available fitness standards and exercise formats.", tint: KinexaTheme.slateAccent),
    ...
    static let risksPage = LegalPage(
        ...
        updated: "April 2026",
        sections: [
            LegalSection(icon: "stethoscope", title: "Consult a Professional", body: "Before beginning any exercise program, consult a qualified medical professional. MVM GetFit is a tracking tool — it does not evaluate your physical readiness, medical history, or health status. That assessment should come from your healthcare provider.", tint: Color(hex: "#EF4444")),
            ...
            LegalSection(icon: "checkmark.circle", title: "Acknowledgment", body: "By using MVM GetFit, you acknowledge that you have read and understand this risk disclosure, that you accept full responsibility for your participation in any physical activity, and that you use this app at your own risk.", tint: KinexaTheme.accent2)
        ]
    )
    ...
    static let accessibilityPage = LegalPage(
        ...
        subtitle: "MVM GetFit is built for everyone. Accessibility is a priority, not an afterthought.",
        updated: "April 2026",
        sections: [
            ...
            LegalSection(icon: "textformat.size", title: "Dynamic Type", body: "MVM GetFit supports Dynamic Type. Increase your preferred text size in iOS Settings and the app scales text throughout to match your preference.", tint: KinexaTheme.slateAccent),
    ...
    static let eulaPage = LegalPage(
        ...
        updated: "April 2026",
        sections: [
            LegalSection(icon: "apple.logo", title: "Apple Standard EULA", body: "MVM GetFit is licensed under Apple's Standard End User License Agreement (EULA) for apps distributed through the Apple App Store.\n\nYou can review the full EULA here:\nhttps://www.apple.com/legal/internet-services/itunes/dev/stdeula/", tint: KinexaTheme.slateAccent),
            LegalSection(icon: "doc.text", title: "License Grant", body: "Subject to the terms of the Apple Standard EULA, you are granted a limited, non-exclusive, non-transferable license to use MVM GetFit on any Apple-branded device that you own or control, as permitted by the Usage Rules set forth in the Apple Media Services Terms and Conditions.", tint: KinexaTheme.accent),
            ...
            LegalSection(icon: "shield.checkered", title: "Disclaimer of Warranties", body: "MVM GetFit is provided \"as is\" and \"as available\" without warranties of any kind. The developer does not warrant that the app will be error-free, uninterrupted, or suitable for any particular purpose.", tint: KinexaTheme.tertiaryText),
