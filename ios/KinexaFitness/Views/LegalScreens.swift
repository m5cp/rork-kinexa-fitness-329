...
enum LegalPages {
    ...
    static let disclaimerPage = LegalPage(
        ...
        sections: [
            ...
            LegalSection(icon: "fork.knife", title: "Nutrition Content", body: "Nutrition features in Kinexa Fitness — including meal logging, calorie tracking, and macro breakdowns — are provided for general informational and tracking purposes only.\n\nKinexa Fitness does not provide dietary advice, meal plans, or individualized nutrition recommendations. AI-generated nutrition estimates are suggestions based on your inputs and may not account for allergies, intolerances, medical conditions, or specific dietary needs.\n\nAlways consult a registered dietitian, nutritionist, or qualified healthcare provider before making significant changes to your diet, especially if you have food allergies, medical conditions, or specific nutritional requirements.\n\nFor personalized nutrition consultations, we recommend connecting with our nutrition partner through the Support section of the app.", tint: Color(hex: "#F59E0B")),
