...
enum LegalPages {
    ...
    static let privacyPage = LegalPage(
        ...
        sections: [
            ...
            LegalSection(icon: "cart", title: "Third-Party Services & In-App Purchases", body: "Kinexa Fitness offers subscriptions and consumable in-app purchases (AI Token Packs) managed through RevenueCat, which processes transactions via Apple's App Store infrastructure. RevenueCat does not receive your fitness data, health data, nutrition data, or any personally identifiable information from Kinexa Fitness.\n\nAI Token Packs are consumable purchases that add bonus AI analysis credits to your account. Token balances are stored locally on your device. Consumable purchases are non-refundable once tokens have been used. Unused tokens never expire.\n\nAI-generated recipe features use the Groq API to process recipe requests. Only the ingredients and preferences you enter are sent — no personal data, health data, or account information is transmitted. No other third-party analytics, advertising, or tracking SDKs are included in this app.", tint: KinexaTheme.accent2),
    ...
    static let termsPage = LegalPage(
        ...
        sections: [
            ...
            LegalSection(icon: "heart.text.square", title: "Health & Nutrition Data", body: "If you grant Apple Health access, Kinexa Fitness reads your activity data for display within the app and writes completed Quick Start workout sessions back to Apple Health so they contribute to your activity rings and workout history. This data is never sold, shared, or transmitted externally.\n\nNutrition data — including meals, calories, macros, and recipes — is stored locally on your device and is never transmitted to any server or third party. Your health and nutrition data stays on your device at all times.", tint: KinexaTheme.accent2),
            LegalSection(icon: "person.fill.checkmark", title: "User Responsibility", body: "You are solely responsible for:\n\n• Knowing your physical capabilities and limitations\n• Using proper exercise form and technique\n• Stopping activity if you experience pain, dizziness, or discomfort\n• Consulting a qualified medical professional before starting any exercise program\n• Consulting a registered dietitian or nutritionist before making significant dietary changes\n• Ensuring exercises and meals you select are appropriate for your fitness level and dietary needs\n• Checking AI-generated recipes for allergens and ingredients that may affect your health\n\nKinexa Fitness provides tools — your safety and dietary decisions are your own.", tint: KinexaTheme.accent),
    ...
    static let disclaimerPage = LegalPage(
        ...
        updated: "April 2026",
        sections: [
            LegalSection(icon: "info.circle", title: "Purpose of This App", body: "Kinexa Fitness is a fitness tracking, nutrition tracking, and accountability tool. It provides workout templates, activity tracking, nutrition logging, recipe discovery, and planning features. The app is designed to help you log, organize, and visualize your own training and nutrition — not to coach, instruct, or prescribe exercises or diets.", tint: KinexaTheme.warning),
