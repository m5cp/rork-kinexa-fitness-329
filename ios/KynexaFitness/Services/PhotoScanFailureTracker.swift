...
@Observable
final class PhotoScanFailureTracker {
    static let shared = PhotoScanFailureTracker()

    static let maxFailures: Int = 10
    static let lockoutDuration: TimeInterval = 24 * 60 * 60

    private let failureCountKey = "photoScan_failureCount"
    private let lockoutStartKey = "photoScan_lockoutStart"
