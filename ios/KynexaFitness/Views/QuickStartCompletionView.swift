        ...
        Button {
            ...
            HStack(spacing: 12) {
                Image(systemName: calendarExported ? "checkmark.circle.fill" : "calendar.badge.plus")
                    .font(.subheadline.weight(.bold))
                    .foregroundStyle(calendarExported ? KynexaTheme.success : KynexaTheme.accent)
                    .frame(width: 36, height: 36)
                    .background((calendarExported ? KynexaTheme.success : KynexaTheme.accent).opacity(0.12))
                    .clipShape(RoundedRectangle(cornerRadius: 10))
        ...
        Button {
            ...
            HStack(spacing: 12) {
                Image(systemName: logged ? "checkmark.circle.fill" : "chart.line.uptrend.xyaxis")
                    .font(.subheadline.weight(.bold))
                    .foregroundStyle(logged ? KynexaTheme.success : Color(hex: "#FF6B35"))
                    .frame(width: 36, height: 36)
                    .background((logged ? KynexaTheme.success : Color(hex: "#FF6B35")).opacity(0.12))
                    .clipShape(RoundedRectangle(cornerRadius: 10))
            ...
            .overlay {
                RoundedRectangle(cornerRadius: 16)
                    .stroke(logged ? KynexaTheme.success.opacity(0.3) : KynexaTheme.border)
            }
        }
        .buttonStyle(PressScaleButtonStyle())
        .disabled(logged)
