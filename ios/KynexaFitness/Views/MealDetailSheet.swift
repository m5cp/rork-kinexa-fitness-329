            ...
            if isAnalyzing {
                ...
                VStack(alignment: .leading, spacing: 14) {
                    ...
                    if !insight.strengths.isEmpty {
                        insightList(title: "Strengths", items: insight.strengths, icon: "checkmark.circle.fill", color: KynexaTheme.success)
                    }

                    if !insight.improvements.isEmpty {
                        insightList(title: "Improvements", items: insight.improvements, icon: "arrow.up.circle.fill", color: KynexaTheme.warning)
                    }
