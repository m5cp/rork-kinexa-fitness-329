...
struct CardioWorkoutsView: View {
    ...
    private func categoryChip(title: String, category: CardioCategory?) -> some View {
        ...
        return Button {
            ...
            .clipShape(Capsule())
            .overlay {
                Capsule().stroke(isSelected ? KynexaTheme.accent : KynexaTheme.border)
            }
        }
        .buttonStyle(.plain)
    }
    ...
    private func difficultyColor(_ level: String) -> Color {
        switch level {
        case "Easy", "Beginner": return KynexaTheme.success
        case "Moderate": return KynexaTheme.accent
        case "Hard": return Color(hex: "#F59E0B")
        default: return KynexaTheme.tertiaryText
        }
    }
}
