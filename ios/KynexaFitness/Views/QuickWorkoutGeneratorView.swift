...
struct QuickWorkoutGeneratorView: View {
        ...
        return Button {
            ...
            HStack(spacing: 14) {
                ...
                Image(systemName: isSelected ? "checkmark.circle.fill" : "circle")
                    .font(.title3)
                    .foregroundStyle(isSelected ? (type.gradient.first ?? KynexaTheme.accent) : KynexaTheme.tertiaryText)
            }
            .padding(14)
            ...
            .overlay {
                RoundedRectangle(cornerRadius: 16)
                    .stroke(isSelected ? (type.gradient.first ?? KynexaTheme.accent).opacity(0.5) : KynexaTheme.border, lineWidth: isSelected ? 1.5 : 1)
            }
        }
        .buttonStyle(PressScaleButtonStyle())
    }
            ...
            Text("\(mins) min")
                ...
                .overlay {
                    RoundedRectangle(cornerRadius: 12)
                        .stroke(isSelected ? Color.clear : KynexaTheme.border)
                }
        }
        .buttonStyle(PressScaleButtonStyle())
    }
    ...
    private func movementRow(_ movement: WODMovement) -> some View {
        ...
        let accent = selectedType.gradient.first ?? KynexaTheme.accent
