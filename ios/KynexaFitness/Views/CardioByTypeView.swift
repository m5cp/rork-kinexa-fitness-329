...
struct CardioByTypeView: View {
    ...
    private func filterChip(title: String, category: CardioCategory?) -> some View {
        ...
        return Button {
            ...
            .padding(.vertical, 8)
            .background(isSelected ? Color(hex: "#EC4899") : KynexaTheme.card)
            .clipShape(Capsule())
            .overlay {
                Capsule().stroke(isSelected ? Color(hex: "#EC4899") : KynexaTheme.border)
            }
        }
        .buttonStyle(.plain)
    }
    ...
    private func difficultyColor(_ level: String) -> Color {
        ...
        case "Moderate": return KynexaTheme.warning
