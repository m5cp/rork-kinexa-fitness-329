        ...
        if isVisible {
            HStack(spacing: 12) {
                Image(systemName: recap.icon)
                    ...
                    .foregroundStyle(recap.isPositive ? KynexaTheme.success : KynexaTheme.warning)
                    .frame(width: 32, height: 32)
                    .background((recap.isPositive ? KynexaTheme.success : KynexaTheme.warning).opacity(0.15))
                    .clipShape(Circle())
