    ...
    var body: some View {
        ...
        .toolbar {
            ToolbarItem(placement: .principal) {
                HStack(spacing: 6) {
                    Circle()
                        .fill(quickStart.isPaused ? KynexaTheme.warning : KynexaTheme.success)
                ...
                Button {
                    ...
                    .background(
                        quickStart.isPaused
                            ...
                            : LinearGradient(colors: [KynexaTheme.warning, KynexaTheme.warning.opacity(0.9)], startPoint: .leading, endPoint: .trailing)
                    )
