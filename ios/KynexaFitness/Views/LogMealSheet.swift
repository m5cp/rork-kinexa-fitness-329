...
struct LogMealSheet: View {
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") { saveMeal() }
                        ...
                        .foregroundStyle(estimatedFoods.isEmpty ? KynexaTheme.tertiaryText : KynexaTheme.success)
    ...
    private func photoTipRow(good: Bool, text: String) -> some View {
        HStack(spacing: 8) {
            Image(systemName: good ? "checkmark.circle.fill" : "xmark.circle.fill")
                .font(.system(size: 11, weight: .bold))
                .foregroundStyle(good ? KynexaTheme.success : KynexaTheme.danger)
            Text(text)
    ...
    private var aiTextLockoutBanner: some View {
        ...
        .padding(14)
        .frame(maxWidth: .infinity, alignment: .leading)
        .background(KynexaTheme.warning.opacity(0.08))
        .clipShape(.rect(cornerRadius: 14))
        .overlay {
            RoundedRectangle(cornerRadius: 14)
                .stroke(KynexaTheme.warning.opacity(0.25))
        }
    }
    ...
    private var estimatedFoodsSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Button {
                ...
                .clipShape(.rect(cornerRadius: 14))
                .shadow(color: KynexaTheme.accent.opacity(0.3), radius: 10, y: 4)
            }
            .buttonStyle(PressScaleButtonStyle())
            .padding(.top, 4)
        }
            ...
            HStack(spacing: 10) {
                Button {
                    ...
                    Image(systemName: "minus")
                        ...
                        .foregroundStyle(servingsValue <= 0.25 ? KynexaTheme.tertiaryText : KynexaTheme.accent)
                        .frame(width: 34, height: 34)
                        .background(KynexaTheme.cardSoft)
                        .clipShape(Circle())
                }
    ...
    private var foodScanLimitBanner: some View {
        ...
        .overlay {
            RoundedRectangle(cornerRadius: 14)
                .stroke(KynexaTheme.warning.opacity(0.2))
        }
    }
