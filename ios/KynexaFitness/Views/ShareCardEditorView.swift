...
struct ShareCardEditorView: View {
                    ...
                    HStack(spacing: 8) {
                        ForEach(PhotoMode.allCases) { mode in
                            Button {
                                ...
                                .foregroundStyle(photoMode == mode ? .white : KynexaTheme.secondaryText)
                                .padding(.horizontal, 14)
                                .padding(.vertical, 8)
                                .background(photoMode == mode ? KynexaTheme.accent : KynexaTheme.cardSoft)
                                .clipShape(Capsule())
                            }
                            .buttonStyle(.plain)
                        }
                        ...
                        HStack(spacing: 8) {
                            ForEach(OverlayCorner.allCases) { corner in
                                Button {
                                    ...
                                    Text(corner.label)
                                        .font(.caption.weight(.semibold))
                                        .foregroundStyle(overlayCorner == corner ? .white : KynexaTheme.secondaryText)
                                        .padding(.horizontal, 12)
                                        .padding(.vertical, 8)
                                        .background(overlayCorner == corner ? KynexaTheme.accent : KynexaTheme.cardSoft)
                                        .clipShape(Capsule())
                                }
                                .buttonStyle(.plain)
                            }
                    ...
                    Image(uiImage: thumb)
                        ...
                        .overlay {
                            RoundedRectangle(cornerRadius: 10)
                                .stroke(isSelected ? KynexaTheme.accent : Color.clear, lineWidth: 2)
                        }
                }
    ...
    private var actionBar: some View {
        HStack(spacing: 12) {
            if let final = compositeImage {
                ShareLink(
                    ...
                    preview: SharePreview("Kynexa Fitness", image: Image(uiImage: final))
                ) {
                    HStack(spacing: 8) {
        ...
        .padding(.horizontal, 20)
        .padding(.vertical, 12)
        .background(KynexaTheme.background)
    }
                            ...
                            HStack(spacing: 8) {
                                ForEach(TextFontOption.allCases) { font in
                                    Button {
                                        ...
                                        Text(font.label)
                                            .font(.caption.weight(.semibold))
                                            .foregroundStyle(item.fontOption == font ? .white : KynexaTheme.secondaryText)
                                            .padding(.horizontal, 14)
                                            .padding(.vertical, 8)
                                            .background(item.fontOption == font ? KynexaTheme.accent : KynexaTheme.cardSoft)
                                            .clipShape(Capsule())
                                    }
                                    .buttonStyle(.plain)
                                }
                                            ...
                                            Circle()
                                                ...
                                                .overlay {
                                                    if item.colorOption == color {
                                                        Circle()
                                                            .stroke(KynexaTheme.accent, lineWidth: 3)
                        ...
                        HStack(spacing: 16) {
                            VStack(alignment: .leading, spacing: 8) {
                                ...
                                Button {
                                    ...
                                    .foregroundStyle(item.isBold ? .white : KynexaTheme.secondaryText)
                                    .padding(.horizontal, 14)
                                    .padding(.vertical, 8)
                                    .background(item.isBold ? KynexaTheme.accent : KynexaTheme.cardSoft)
                                    .clipShape(Capsule())
                                }
                                .buttonStyle(.plain)
                            }
                                ...
                                ForEach(TextAlignment.allCases) { align in
                                    Button {
                                        ...
                                        Image(systemName: align.icon)
                                            ...
                                            .foregroundStyle(item.alignment == align ? .white : KynexaTheme.secondaryText)
                                            .frame(width: 44, height: 36)
                                            .background(item.alignment == align ? KynexaTheme.accent : KynexaTheme.cardSoft)
                                            .clipShape(RoundedRectangle(cornerRadius: 10))
                                    }
                                    .buttonStyle(.plain)
                                }
                            ...
                            HStack(spacing: 8) {
                                ForEach(TextVerticalPosition.allCases) { pos in
                                    Button {
                                        ...
                                        .foregroundStyle(item.verticalPosition == pos ? .white : KynexaTheme.secondaryText)
                                        .padding(.horizontal, 14)
                                        .padding(.vertical, 8)
                                        .background(item.verticalPosition == pos ? KynexaTheme.accent : KynexaTheme.cardSoft)
                                        .clipShape(Capsule())
                                    }
                                    .buttonStyle(.plain)
                                }
