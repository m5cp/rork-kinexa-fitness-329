...
struct PlanView: View {
                    ...
                    Button {
                        ...
                        VStack(spacing: 6) {
                            ...
                            Text(dayNumber(date))
                                ...
                                .foregroundStyle(
                                    isSelected ? .white :
                                    isCompleted ? KynexaTheme.success :
                                    isToday ? KynexaTheme.accent :
                                    KynexaTheme.primaryText
                                )

                            Circle()
                                .fill(
                                    isCompleted ? KynexaTheme.success :
                                    hasWorkout ? KynexaTheme.accent.opacity(0.6) :
                                    Color.clear
                                )
                        ...
                        .background {
                            if isSelected {
                                RoundedRectangle(cornerRadius: 14)
                                    ...
                                    .shadow(color: KynexaTheme.accent.opacity(0.3), radius: 8, y: 4)
                            } else if isToday {
                                RoundedRectangle(cornerRadius: 14)
                                    .stroke(KynexaTheme.accent.opacity(0.3), lineWidth: 1)
                            }
                        }
                    }
                }
    ...
    private func selectedWorkoutCard(_ day: WorkoutDay) -> some View {
        ...
        .shadow(color: (day.isCompleted ? Color(hex: "#059669") : KynexaTheme.accent).opacity(0.2), radius: 20, y: 12)
    }
    ...
    private func workoutRow(_ day: WorkoutDay, offset: Int) -> some View {
        ...
        return Button {
                ...
                VStack(spacing: 2) {
                    ...
                    Text(dayNumber(day.date))
                        ...
                        .foregroundStyle(
                            ...
                            calendar.isDateInToday(day.date) ? KynexaTheme.accent :
            ...
            .padding(.vertical, 12)
            .background(
                isSelected ? KynexaTheme.accent.opacity(0.08) :
                KynexaTheme.card.opacity(day.isCompleted ? 0.5 : 1)
            )
            .overlay {
                RoundedRectangle(cornerRadius: 14)
                    .stroke(
                        isSelected ? KynexaTheme.accent.opacity(0.2) :
    ...
    private func recoveryRow(_ day: WorkoutDay, offset: Int) -> some View {
        ...
        return Button {
            ...
            .padding(.vertical, 12)
            .background(
                isSelected ? KynexaTheme.accent.opacity(0.05) : KynexaTheme.card.opacity(0.4)
            )
            .overlay {
                RoundedRectangle(cornerRadius: 14)
                    .stroke(
                        isSelected ? KynexaTheme.accent.opacity(0.15) : KynexaTheme.border.opacity(0.5)
                    )
            }
            .clipShape(RoundedRectangle(cornerRadius: 14))
        }
