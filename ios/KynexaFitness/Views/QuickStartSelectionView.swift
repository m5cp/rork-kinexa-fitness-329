...
struct QuickStartSelectionView: View {
    ...
    private func activityCard(_ activity: QuickStartActivity) -> some View {
        ...
        return Button {
                    ...
                    Circle()
                        .fill(
                            isSelected
                                ...
                                : LinearGradient(colors: [KynexaTheme.cardSoft, KynexaTheme.cardSoft], startPoint: .topLeading, endPoint: .bottomTrailing)
                        )
                        .frame(width: 52, height: 52)

                    Image(systemName: activity.icon)
                        .font(.system(size: 22, weight: .semibold))
                        .foregroundStyle(isSelected ? .white : KynexaTheme.secondaryText)
                }

                VStack(spacing: 4) {
                    Text(activity.rawValue)
                        .font(.subheadline.weight(.semibold))
                        .foregroundStyle(isSelected ? KynexaTheme.primaryText : KynexaTheme.secondaryText)
                    ...
                    if activity.usesGPS {
                        ...
                        .foregroundStyle(isSelected ? Color(hex: hex.0) : KynexaTheme.tertiaryText)
                    } else {
                        Text("Timer Only")
            ...
            .background(isSelected ? KynexaTheme.card : KynexaTheme.card.opacity(0.6))
            .overlay {
                RoundedRectangle(cornerRadius: 18)
                    .stroke(isSelected ? Color(hex: hex.0).opacity(0.5) : KynexaTheme.border, lineWidth: isSelected ? 1.5 : 1)
            }
        ...
        if activity.usesGPS {
            ...
            HStack(spacing: 12) {
                Image(systemName: "timer")
                    .font(.body.weight(.semibold))
                    .foregroundStyle(KynexaTheme.slateAccent)
                    .frame(width: 36, height: 36)
                    .background(KynexaTheme.slateAccent.opacity(0.12))
                    .clipShape(RoundedRectangle(cornerRadius: 10))
        ...
        Button {
            ...
            .background(
                quickStart.selectedActivity != nil
                    ...
                    : LinearGradient(colors: [KynexaTheme.cardSoft, KynexaTheme.cardSoft], startPoint: .leading, endPoint: .trailing)
            )
            .clipShape(RoundedRectangle(cornerRadius: 16))
            .shadow(color: quickStart.selectedActivity != nil ? KynexaTheme.accent.opacity(0.3) : .clear, radius: 16, y: 8)
        }
