            ...
            ScrollView(showsIndicators: false) {
                VStack(spacing: 20) {
                    ...
                    VStack(alignment: .leading, spacing: 14) {
                        ...
                        macroField(label: "Calories", text: $calories, unit: "cal", color: KynexaTheme.success)
                    ...
                    Button {
                        ...
                        .background(
                            LinearGradient(
                                colors: isValid ? [Color(hex: "#F59E0B"), Color(hex: "#D97706")] : [KynexaTheme.tertiaryText, KynexaTheme.tertiaryText],
                                startPoint: .leading,
                                endPoint: .trailing
                            )
                        )
