            ...
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Log") { logSession() }
                        ...
                        .foregroundStyle(selectedActivity != nil ? accentColor : KynexaTheme.tertiaryText)
        ...
        return Button {
            ...
            .overlay {
                RoundedRectangle(cornerRadius: 14)
                    .stroke(isSelected ? accentColor : KynexaTheme.border, lineWidth: isSelected ? 1.5 : 0.5)
            }
