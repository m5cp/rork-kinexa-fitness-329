        ...
        VStack(spacing: 16) {
            ZStack {
                Circle()
                    .fill(
                        RadialGradient(
                            colors: [KynexaTheme.accent.opacity(0.3), .clear],
                            center: .center,
                            startRadius: 20,
                            endRadius: 60
                        )
                ...
                Circle()
                    ...
                    .shadow(color: KynexaTheme.accent.opacity(0.4), radius: 20, y: 8)
        ...
        return Button {
            ...
            VStack(spacing: 0) {
                ...
                HStack(spacing: 14) {
                    ZStack {
                        Circle()
                            .stroke(isSelected ? KynexaTheme.accent : KynexaTheme.tertiaryText.opacity(0.4), lineWidth: 2)
                    ...
                    VStack(alignment: .trailing, spacing: 2) {
                        Text(package.storeProduct.localizedPriceString)
                            ...
                            .foregroundStyle(isSelected ? KynexaTheme.accent : KynexaTheme.primaryText)
            ...
            .background(
                LinearGradient(
                    colors: [isSelected ? KynexaTheme.accent.opacity(0.06) : KynexaTheme.card, isSelected ? KynexaTheme.accent.opacity(0.03) : KynexaTheme.card],
                    startPoint: .topLeading,
                    endPoint: .bottomTrailing
                )
            )
            ...
            .overlay {
                RoundedRectangle(cornerRadius: 18)
                    .stroke(
                        isSelected ? KynexaTheme.accent.opacity(0.5) : KynexaTheme.border,
        ...
        Group {
            if let current = store.offerings?.current, let selected = selectedPackage(from: current) {
                Button {
                    ...
                    .clipShape(.rect(cornerRadius: 18))
                    .shadow(
                        color: KynexaTheme.accent.opacity(0.3),
                        radius: 16, y: 8
                    )
                }
