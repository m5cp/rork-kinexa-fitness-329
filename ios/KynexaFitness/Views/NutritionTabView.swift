...
struct NutritionTabView: View {
    ...
    private var profileSummaryRow: some View {
        ...
        return Button {
            ...
            .overlay { RoundedRectangle(cornerRadius: 14).stroke(KynexaTheme.border) }
        }
        .buttonStyle(PressScaleButtonStyle())
    }
                    ...
                    Button {
                        ...
                        VStack(spacing: 6) {
                            Text(dayLabel(date))
                                ...
                                .foregroundStyle(isSelected ? .white : KynexaTheme.tertiaryText)
                            Text("\(Calendar.current.component(.day, from: date))")
                                .font(.system(size: 16, weight: isSelected ? .bold : .semibold))
                                .foregroundStyle(isSelected ? .white : KynexaTheme.primaryText)
                            if isToday {
                                Circle()
                                    .fill(isSelected ? .white : KynexaTheme.accent)
    ...
    private var calorieRingCard: some View {
        VStack(spacing: 20) {
            ZStack {
                Circle()
                    .stroke(KynexaTheme.cardSoft, lineWidth: 14)
            ...
            Text("\(remaining) cal remaining")
                ...
                .foregroundStyle(remaining > 0 ? KynexaTheme.success : KynexaTheme.warning)
                        ...
                        VStack(spacing: 4) {
                            ...
                            RoundedRectangle(cornerRadius: 4)
                                .fill(
                                    ...
                                    ? KynexaTheme.warning.opacity(0.7)
                                    : KynexaTheme.success.opacity(0.7)
                                )
